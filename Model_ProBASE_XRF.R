...
banco.geral       <- read.csv("XRF.csv"    , sep = ";", header = T)
banco.spectra.geral  <- data.frame(banco.geral[ ,29:63])
...
banco.Sand  <- data.frame(cbind(banco.geral[,c(1,2)], banco.spectra.geral[ ,c(seq(1,35))]))
...
banco.Silt  <- data.frame(cbind(banco.geral[,c(1,3)], banco.spectra.geral[ ,c(seq(1,35))]))
...
banco.Clay  <- data.frame(cbind(banco.geral[,c(1,4)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############ pH##########
banco.pH  <- data.frame(cbind(banco.geral[,c(1,5)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## Organic Matter ###################
banco.OM  <- data.frame(cbind(banco.geral[,c(1,8)], banco.spectra.geral[ ,c(seq(1,35))]))
...
###################### P ###########
banco.P  <- data.frame(cbind(banco.geral[,c(1,10)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############### K ################################
banco.K  <- data.frame(cbind(banco.geral[,c(1,11)], banco.spectra.geral[ ,c(seq(1,35))]))
...
################## Ca  #######################
banco.Ca  <- data.frame(cbind(banco.geral[,c(1,12)], banco.spectra.geral[ ,c(seq(1,35))]))
...
#######################  Mg #####################
banco.Mg  <- data.frame(cbind(banco.geral[,c(1,13)], banco.spectra.geral[ ,c(seq(1,35))]))
...
###################  Al ###########################
banco.Al  <- data.frame(cbind(banco.geral[,c(1,14)], banco.spectra.geral[ ,c(seq(1,35))]))
...
##################  H + Al ##########################
banco.HAl  <- data.frame(cbind(banco.geral[,c(1,16)], banco.spectra.geral[ ,c(seq(1,35))]))
...
##################### Sum Bases #####################
banco.SB  <- data.frame(cbind(banco.geral[,c(1,17)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## CEC ###########################
banco.CEC  <- data.frame(cbind(banco.geral[,c(1,18)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## V ###########################
banco.V  <- data.frame(cbind(banco.geral[,c(1,19)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## M ###########################
banco.M  <- data.frame(cbind(banco.geral[,c(1,21)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## S ###########################
banco.S  <- data.frame(cbind(banco.geral[,c(1,22)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## B ###########################
banco.B  <- data.frame(cbind(banco.geral[,c(1,24)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## Fe ###########################
banco.Fe  <- data.frame(cbind(banco.geral[,c(1,25)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## Cu ###########################
banco.Cu  <- data.frame(cbind(banco.geral[,c(1,26)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## Zn ###########################
banco.Zn  <- data.frame(cbind(banco.geral[,c(1,27)], banco.spectra.geral[ ,c(seq(1,35))]))
...
############## Mn ###########################
banco.Mn  <- data.frame(cbind(banco.geral[,c(1,28)], banco.spectra.geral[ ,c(seq(1,35))]))
